...
import '../../../bloc/cart_bloc/cart_bloc_2.dart';
import '../../../bloc/cart_bloc/cart_state_2.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Số lượng Oppo: ${itemOppo.length.toString()}',
          style:
